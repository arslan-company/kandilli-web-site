          ...
          <div class="col-xl-12 col-xxl-10">
            ...
            <form class="form" id="kt_form">
              ...
              <div class="pb-5" data-wizard-type="step-content">
                ...
                <div class="row justify-content-center py-8 px-8 py-md-36 px-md-0 bg-primary m-0">
                  <div class="col-md-9">
                    <div class="d-flex justify-content-between align-items-md-center flex-column flex-md-row">
                      <div class="d-flex flex-column px-0 order-2 order-md-1">
                        ...
                        <!--                        </a>-->
                        <!--end::Logo-->
                        <span class="d-flex flex-column font-size-h4 font-weight-bold text-white">
<!--                          <span>-->
                          <!--                            <strong>{{ Appointment.Day }}</strong> Tarihine</span>-->
                          <!--														<span><strong>{{ seansTime }}</strong> Seansına Randevu Özeti</span>-->
                        </span>
                      </div>
                      <h1 class="display-3 font-weight-boldest text-white order-1 order-md-2">Randevu Özeti</h1>
                    </div>
                  </div>
                </div>
                <div class="row justify-content-center bg-primary py-8 px-8 py-md-10 px-md-0 mx-0">
                  <div class="col-md-10">
                    <div class="table-responsive">
                      <table class="table">
                        <thead>
                        <tr>
                          <th class="font-weight-bold text-white">Müşteri İsmi</th>
                          <th class="font-weight-bold text-white">Telefonu</th>
                          <th class="font-weight-bold text-white">Mail</th>
                          <th class="font-weight-bold text-white">Kişi Sayısı</th>
                          <th class="font-weight-bold text-white text-right">Randevu Günü ve Saati</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr class="font-weight-bolder text-white">
                          ...
                          <td class="text--white font-size-h4 font-weight-boldest text-right">
